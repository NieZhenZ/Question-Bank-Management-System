...
<html>
    ...
    <div class="header">
    	...
    	<div id="div1">
    		<form id="add" name="add" action="../InsertQuestion" method="post" enctype="multipart/form-data">
    		<table id="tab1">
    			<tr>
    			...
    			<tr>
    				...
    				<td >
    					<input type="text"  name="question" id="question" placeholder="请输入题目" value="">	
    				</td>
    			</tr>
    			<tr>
    			...
    			<tr>
    				...
    				<td><input type="text" name="answer" placeholder="请输入答案" id="answer" value=""></td>
    			</tr>
    			<tr>
    				<td ></td>
