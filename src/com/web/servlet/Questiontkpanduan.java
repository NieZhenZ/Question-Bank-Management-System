...
public class Questiontkpanduan extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) 
		...
		Paper paper = new Paper(shuzu[0], shuzu[1], shuzu[2], shuzu[3]);
		System.out.println(paper.toString());
		try {
				con=DBUtil.getConnection();
				if(new PaperInterfaceImplDao().insertk(paper,con)){
