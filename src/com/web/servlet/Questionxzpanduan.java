...
public class Questionxzpanduan extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) 
        ...
        if(checkbox_11!=null)
        {
           shuzu[ti] = Integer.parseInt(checkbox_11);
           ti++;
        }
	    String message1 = null;
		Paper paper = new Paper(shuzu[0], shuzu[1], shuzu[2], shuzu[3],shuzu[4]);
		System.out.println(paper.toString());
		try {
				con=DBUtil.getConnection();
				if(new PaperInterfaceImplDao().insertxz(paper,con)){
